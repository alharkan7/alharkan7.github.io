  ...
  sections: [
    {
      ...
      viz: {
        ...
        captionHtml: "Internet penetration surpassed radio listenership around 2015, creating a dual-media landscape heading into the 2019 elections.",
        mount: "svg",
        legend: true,
        props: {
    ...
    },
    {
      ...
      viz: {
        ...
        captionHtml: "Three categories of independent variables — Media, Sociological, and Economic-Political — orbiting two outcome constructs.",
        mount: "svg",
        props: {
          centers: [
    ...
    },
    {
      ...
      viz: {
        ...
        captionHtml: "Animated paths show causal direction between media variables and electoral outcomes. Line thickness represents path coefficient magnitude.",
        mount: "svg",
        props: {
          nodes: [
    ...
    },
    {
      ...
      viz: {
        ...
        captionHtml: "Each point is a province. The upward trend for Radio consumption contrasts with the flat trend for Internet, revealing radio's unexpected civic power.",
        mount: "svg",
        props: {
          xDomain: [32, 70],
          yDomain: [65, 92],
    ...
    },
    {
      ...
      viz: {
        ...
        captionHtml: "Highlighted cells indicate statistically significant relationships (p &lt; 0.05). Each media platform triggers support for different parties.",
        mount: "svg",
        props: {
    ...
    },
    {
      ...
      viz: {
        ...
        captionHtml: "The combined model that integrates media with sociological and economic variables dramatically outperforms media-only models.",
        mount: "svg",
        props: {
          data: [
    ...
    },
    {
      ...
      viz: {
        ...
        captionHtml: "Future research should zoom into Kabupaten/Kota level data to uncover the truly local dynamics shaping Indonesian democracy.",
        mount: "div",
        props: {
          domain: [68, 90],
          provinces: [
            "Aceh", "Sumut", "Sumbar", "Riau", "Jambi", "Sumsel", "Bengkulu", "Lampung", "Bangka", "Kepri",
            "DKI", "Jabar", "Jateng", "DIY", "Jatim", "Banten", "Bali", "NTB", "NTT", "Kalbar", "Kalteng",
            "Kalsel", "Kaltim", "Kalut", "Sulut", "Sulteng", "Sulsel", "Sultra", "Gorontalo", "Sulbar",
