...
- Layout component: [src/components/ScrollyTemplate.astro](../../components/ScrollyTemplate.astro)
- Story data: [src/content/scrolly-example.ts](../../content/scrolly-example.ts)
...
2) **Layout template** (`src/components/ScrollyTemplate.astro`)  
...
4) **Per-page story data** (`src/content/...`)  
...
Related directories:
- Layout: `src/components/ScrollyTemplate.astro`
- Page data: `src/content/*.ts`
...
- `src/content/ai-explainer.ts`

Start by copying the structure from:
- [src/content/scrolly-example.ts](../../content/scrolly-example.ts)
...
- [src/components/ScrollyTemplate.astro](../../components/ScrollyTemplate.astro)

## Styling

The current demo page reuses the original election CSS:
- `public/components/media-election-2019/style.css`
